...
exports.colors = exports.getDifs = exports.getRandomColor = void 0;
function getRandomColor() {
    const index = Math.floor(Math.random() * exports.colors.length);
    return exports.colors[index];
}
exports.getRandomColor = getRandomColor;
function getDifs(color, colors) {
    const result = [];
